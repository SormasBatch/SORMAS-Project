...
public class MainScreen extends HorizontalLayout {
    ...
    public MainScreen(SormasUI ui) {
        ...
        if (user.isGdpr()) {
            Window subWindowGdpR = new Window(I18nProperties.getString(Strings.gdpr));
            ...
            CheckBox checkBoxRgpd = new CheckBox(I18nProperties.getString(Strings.messageCheckGdpr));
            ...
            Button buttonGdpr = ButtonHelper.createButton(
                    I18nProperties.getString(Strings.validate),
                    event -> {
