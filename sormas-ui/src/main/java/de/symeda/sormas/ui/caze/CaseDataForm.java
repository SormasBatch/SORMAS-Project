...
public class CaseDataForm extends AbstractEditForm<CaseDataDto> {
	...
	private static final String HTML_LAYOUT =
			loc(CASE_DATA_HEADING_LOC) +
					...
					fluidRowLocs(4, CaseDataDto.FOLLOW_UP_UNTIL, 8, CaseDataDto.OVERWRITE_FOLLOW_UP_UTIL) +
	...
	public CaseDataForm(PersonDto person, Disease disease, SymptomsDto symptoms, ViewMode viewMode, boolean isInJurisdiction) {
	...
	protected void addFields() {
		...
		addField(CaseDataDto.OVERWRITE_FOLLOW_UP_UTIL, CheckBox.class);
		...
		FieldHelper.setReadOnlyWhen(
				...
				CaseDataDto.OVERWRITE_FOLLOW_UP_UTIL,
